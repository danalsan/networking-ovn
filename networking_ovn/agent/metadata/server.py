...
class MetadataProxyHandler(object):
    ...
    def _get_instance_and_project_id(self, req):
        ...
        ports = self.sb_idl.get_network_ports_by_ip(network_id, remote_address)
...
class UnixDomainMetadataProxy(object):
    ...
    def run(self):
        ...
        server.start(MetadataProxyHandler(self.conf, self.sb_idl),
